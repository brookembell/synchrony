# Analysis for synchrony abstract for Sunbelt 2018
# Updated: 1/21/18
# Author: Brooke Bell
...
# LOOK AT BITES ONLY AT TABLE (DO NOT RUN) -----
...
# FAMILY 01
unique(fam01$SubjectID)
combn(unique(fam01$SubjectID), 2)

dyad1 <- subset(fam01, SubjectID == "102" | SubjectID == "105")
write.csv(dyad1, file = "dyad1.csv", row.names = FALSE)
dyad2 <- subset(fam01, SubjectID == "105" | SubjectID == "103")
write.csv(dyad2, file = "dyad2.csv", row.names = FALSE)
dyad3 <- subset(fam01, SubjectID == "102" | SubjectID == "103")
write.csv(dyad3, file = "dyad3.csv", row.names = FALSE)

# FAMILY 07
unique(fam07$SubjectID)
combn(unique(fam07$SubjectID), 2)

dyad4 <- subset(fam07, SubjectID == "701" | SubjectID == "702")
write.csv(dyad4, file = "dyad4.csv", row.names = FALSE)
dyad5 <- subset(fam07, SubjectID == "701" | SubjectID == "703")
write.csv(dyad5, file = "dyad5.csv", row.names = FALSE)
dyad6 <- subset(fam07, SubjectID == "702" | SubjectID == "703")
write.csv(dyad6, file = "dyad6.csv", row.names = FALSE)

# FAMILY 09
unique(fam09$SubjectID)
combn(unique(fam09_at_table$SubjectID), 2)

dyad7 <- subset(fam09, SubjectID == "901" | SubjectID == "902")
write.csv(dyad7, file = "dyad7.csv", row.names = FALSE)
dyad8 <- subset(fam09, SubjectID == "901" | SubjectID == "903")
write.csv(dyad8, file = "dyad8.csv", row.names = FALSE)
dyad9 <- subset(fam09, SubjectID == "902" | SubjectID == "903")
write.csv(dyad9, file = "dyad9.csv", row.names = FALSE)

# FAMILY 13a
unique(fam13a$SubjectID)
combn(unique(fam13a$SubjectID), 2)

dyad10 <- subset(fam13a, SubjectID == "1306" | SubjectID == "1301")
write.csv(dyad10, file = "dyad10.csv", row.names = FALSE)
dyad11 <- subset(fam13a, SubjectID == "1306" | SubjectID == "1302")
write.csv(dyad11, file = "dyad11.csv", row.names = FALSE)
dyad12 <- subset(fam13a, SubjectID == "1301" | SubjectID == "1302")
write.csv(dyad12, file = "dyad12.csv", row.names = FALSE)

# FAMILY 13b
unique(fam13b$SubjectID)
combn(unique(fam13b$SubjectID), 2)

dyad13 <- subset(fam13b, SubjectID == "1305" | SubjectID == "1303")
write.csv(dyad13, file = "dyad13.csv", row.names = FALSE)
dyad14 <- subset(fam13b, SubjectID == "1305" | SubjectID == "1304")
write.csv(dyad14, file = "dyad14.csv", row.names = FALSE)
dyad15 <- subset(fam13b, SubjectID == "1303" | SubjectID == "1304")
write.csv(dyad15, file = "dyad15.csv", row.names = FALSE)

# FAMILY 15
unique(fam15$SubjectID)
combn(unique(fam15$SubjectID), 2)

dyad16 <- subset(fam15, SubjectID == "1501" | SubjectID == "1503")
write.csv(dyad16, file = "dyad16.csv", row.names = FALSE)
dyad17 <- subset(fam15, SubjectID == "1501" | SubjectID == "1502")
write.csv(dyad17, file = "dyad17.csv", row.names = FALSE)
dyad18 <- subset(fam15, SubjectID == "1503" | SubjectID == "1502")
write.csv(dyad18, file = "dyad18.csv", row.names = FALSE)

# FAMILY 17
unique(fam17$SubjectID)
combn(unique(fam17$SubjectID), 2)

dyad19 <- subset(fam17, SubjectID == "1701" | SubjectID == "1703")
write.csv(dyad19, file = "dyad19.csv", row.names = FALSE)
dyad20 <- subset(fam17, SubjectID == "1701" | SubjectID == "1704")
write.csv(dyad20, file = "dyad20.csv", row.names = FALSE)
dyad21 <- subset(fam17, SubjectID == "1701" | SubjectID == "1702")
write.csv(dyad21, file = "dyad21.csv", row.names = FALSE)
dyad22 <- subset(fam17, SubjectID == "1703" | SubjectID == "1704")
write.csv(dyad22, file = "dyad22.csv", row.names = FALSE)
dyad23 <- subset(fam17, SubjectID == "1703" | SubjectID == "1702")
write.csv(dyad23, file = "dyad23.csv", row.names = FALSE)
dyad24 <- subset(fam17, SubjectID == "1704" | SubjectID == "1702")
...
# ALL DA SUMMARY STATS -----

# join demographic and bite data
demographics <- read.csv("~/Dropbox (Metzlab - VS)/SBM 18/Participant masterlist.csv")
...
# demographics of only those who participated in eating session!
demographics1 <- left_join(subject_list, demographics)

sum(demographics1$Child)
sum(demographics1$Parent)

mean(demographics1$Age) #24.03846
mean(subset(demographics1$Age, demographics1$Child == 1))
sd(subset(demographics1$Age, demographics1$Child == 1))
mean(subset(demographics1$Age, demographics1$Child == 0))
sd(subset(demographics1$Age, demographics1$Child == 0))
...
median(subset(DAT_full$bites, DAT_full$Gender == "F"))
median(subset(DAT_full$bites, DAT_full$Gender == "M"))
mean(subset(DAT_full$bites, DAT_full$Gender == "F"))
mean(subset(DAT_full$bites, DAT_full$Gender == "M"))
...
# calculate power for comparing familes
...
dyad3_wide <- reshape(DAT_full, idvar = "dyadid", timevar = "person", direction = "wide")
